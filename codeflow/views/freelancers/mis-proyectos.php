...
<body>
            ...
            <div class="dashboard-content">
                ...
                <section class="projects-list-section">
                    ...
                    <div class="projects-grid">
                        <!-- Proyecto 1 -->
                        <?php foreach ($proyectosFreelancer as $proyecto): ?>
                            <div class="project-card-container highlight">
                                <div class="project-card-header">
                                    <h3><?php echo htmlspecialchars($proyecto['titulo']) ?></h3>
                                    <span class="project-status <?php echo strtolower(str_replace(' ', '-', $proyecto['estado']))?>">
    ...
    <!-- Modal Crear Tareas -->
    <div class="project-modal" id="createTaskModal" aria-hidden="true" style="display: none;">
        <div class="modal-overlay" tabindex="-1" data-close-modal>
                ...
                <form id="taskForm" method="POST" action="../../backend/tareas/crear-tareas.php">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="taskTitle">Tarea</label>
                            <div class="input-text">
                                <input type="text" name="task-title" id="taskTitle" placeholder="Ej: Crear Requerimientos" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="taskDescription">Descripción detallada</label>
                            <div class="input-text">
                                <textarea name="task-description" class="projectDescription" rows="5"
                                placeholder="Describe los objetivos, requisitos y especificaciones de la tarea..."
                                required></textarea>
                            </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-calendar-alt"></i>
                                    <input type="date" name="limit-date" id="taskDeadline" required>
                                </div>
                            </div>
                        </div>
                    </div>
